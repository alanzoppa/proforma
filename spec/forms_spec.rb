...
describe "A more complicated form with multiple fields" do
  ...
  it "should produce a properly formatted form" do
    @more_complicated_form.to_html.should == [
      ...
      "<input id=\"id_gender_choice_male\" type=\"radio\" value=\"Male\" name=\"gender_choice\" /><label for=\"id_gender_choice_male\">Male</label>",
      "<input id=\"id_gender_choice_female\" type=\"radio\" value=\"Female\" name=\"gender_choice\" /><label for=\"id_gender_choice_female\">Female</label>",
      "</fieldset>",
      "</div>",
      "<div class=\"more_complicated\">",
