...
describe "A more complicated form with multiple fields" do
  ...
  it "should produce a properly indented form" do
    @more_complicated_form.to_html.should == [
      ...
      "<input type='radio' name='gender_choice' id='id_gender_choice_male' value='Male' /><label for='id_gender_choice_male'>Male</label>",
      "<input type='radio' name='gender_choice' id='id_gender_choice_female' value='Female' /><label for='id_gender_choice_female'>Female</label>",
      "</fieldset>",
      "</div>",
      "<div class='more_complicated'>",
